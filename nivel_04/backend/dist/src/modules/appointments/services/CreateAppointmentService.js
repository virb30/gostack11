...
var CreateAppointmentService = /** @class */ (function () {
    function CreateAppointmentService(appointmentsRepository, notificaitonsRepository) {
        this.appointmentsRepository = appointmentsRepository;
        this.notificaitonsRepository = notificaitonsRepository;
    }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.notificaitonsRepository.create({
